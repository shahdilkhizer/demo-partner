...
export default class PwchronoEmployeeDirectory extends LightningElement {
  ...
  @track activeAddTab = "basic-info";
  @track employeeAvatarPreview = null;
  @track showPassword = false;
  @track showConfirmPassword = false;
  @track autoGeneratedEmpId = "EMP -0024";
  @track isAllModulesEnabled = true;
  ...
  @track permissionsList = [
    { id: "holidays", name: "Holidays", enabled: true, read: true, write: false, create: false, delete: true, import: false, export: false },
    { id: "leaves", name: "Leaves", enabled: false, read: false, write: false, create: false, delete: false, import: false, export: false },
    { id: "clients", name: "Clients", enabled: false, read: false, write: false, create: false, delete: false, import: false, export: false },
    { id: "projects", name: "Projects", enabled: false, read: false, write: false, create: false, delete: false, import: false, export: false },
    { id: "tasks", name: "Tasks", enabled: false, read: false, write: false, create: false, delete: false, import: false, export: false },
    { id: "chats", name: "Chats", enabled: false, read: false, write: false, create: false, delete: false, import: false, export: false },
    { id: "assets", name: "Assets", enabled: true, read: false, write: false, create: true, delete: false, import: true, export: false },
    { id: "timing", name: "Timing Sheets", enabled: false, read: false, write: false, create: false, delete: false, import: false, export: false }
  ];
  ...
  get isEditMode() {
    return Boolean(this.employeeForm && this.employeeForm.Id);
  }

  get isAddBasicTabActive() {
    return this.activeAddTab === "basic-info";
  }

  get isAddPermTabActive() {
    return this.activeAddTab === "permissions";
  }

  get addBasicTabClass() {
    return this.activeAddTab === "basic-info" ? "nav-link active" : "nav-link";
  }

  get addPermTabClass() {
    return this.activeAddTab === "permissions" ? "nav-link active" : "nav-link";
  }
  ...
  get passwordToggleClass() {
    return this.showPassword ? "ti ti-eye" : "ti ti-eye-off";
  }

  get confirmPasswordToggleClass() {
    return this.showConfirmPassword ? "ti ti-eye" : "ti ti-eye-off";
  }
  ...
  initEmployeeExtraDetails(emp) {
    ...
    return {
      ...
      assetInfo: emp.assetInfo || {
        displayText: 'MacBook Pro 16" (M2 Max) ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¾Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¾ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€šÃ‚Â¡ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¡ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¾Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€šÃ‚Â¡ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¡ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¡ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¡ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¦ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¡ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€šÃ‚Â¡ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¡ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¾Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€šÃ‚Â¡ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¦ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€šÃ‚Â¡ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¡ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ 32GB RAM',
        serialNumber: 'C02G451XMD6R',
        assignedDate: emp.joiningDate || '28 Dec 2025'
      }
    };
  }
  ...
  handleBackToList(event) {
    ...
    this.currentView = this.previousView === "grid" ? "grid" : "list";
  ...
  handleOpenAddModal() {
    ...
    const nextNum = (this.employees?.length || 0) + 24;
    this.autoGeneratedEmpId = `EMP -00${nextNum}`;
    this.activeAddTab = "basic-info";
    this.employeeAvatarPreview = null;
    ...
    this.employeeForm = {
      ...
      FirstName: "",
      LastName: "",
      Employee_ID__c: `EMP-00${nextNum}`,
      Date_of_Joining__c: today,
      Username: "",
      Email: "",
      Password: "",
      ConfirmPassword: "",
      Phone: "",
      Company: "The Lodestone Group",
  ...
  handleSelectAddBasicTab() {
    this.activeAddTab = "basic-info";
  }

  handleSelectAddPermTab() {
    this.activeAddTab = "permissions";
  }
  ...
  handleEmployeeImageUpload(event) {
    const file = event.target.files[0];
    if (file) {
      if (file.size > 4 * 1024 * 1024) {
        this.showToast("Validation", "Image should be below 4 MB", "warning");
        return;
      }
      const reader = new FileReader();
      reader.onload = () => {
        this.employeeAvatarPreview = reader.result;
        this.employeeForm.Photo_Url__c = reader.result;
      };
      reader.readAsDataURL(file);
    }
  }

  handleCancelEmployeeImage() {
    this.employeeAvatarPreview = null;
    this.employeeForm.Photo_Url__c = null;
  }

  handleToggleModule(event) {
    const id = event.target.dataset.id;
    this.permissionsList = this.permissionsList.map((p) =>
      p.id === id ? { ...p, enabled: event.target.checked } : p
    );
  }

  handleTogglePermAction(event) {
    const id = event.target.dataset.id;
    const action = event.target.dataset.action;
    this.permissionsList = this.permissionsList.map((p) =>
      p.id === id ? { ...p, [action]: event.target.checked } : p
    );
  }

  handleToggleEnableAllModules(event) {
    const val = event.target.checked;
    this.isAllModulesEnabled = val;
    this.permissionsList = this.permissionsList.map((p) => ({
      ...p,
      enabled: val
    }));
  ...
  handleToggleSelectAllPerms(event) {
    const val = event.target.checked;
  ...
  handleOpenEditEmployeeModal(event) {
    ...
    if (emp) {
      ...
      this.autoGeneratedEmpId = emp.empId || "EMP -0001";
      this.activeAddTab = "basic-info";
      this.employeeAvatarPreview = emp.avatarUrl || null;
      this.showPassword = false;
      this.showConfirmPassword = false;
      ...
      this.employeeForm = {
        ...
        Employee_ID__c: emp.empId || "",
        Date_of_Joining__c: this.parseFormattedDate(emp.joiningDate),
        Username: emp.firstName || emp.name || "",
        Email: emp.email || "",
        Password: "",
        ConfirmPassword: "",
        Phone: emp.phone || "",
        Company: emp.accountName || "The Lodestone Group",
        Department: emp.department || "Developer",
        Title: emp.title || "Developer",
        Description: emp.about || "",
        Photo_Url__c: emp.avatarUrl || ""
      };
      this.isAddEditModalOpen = true;
    }
  }
  ...
  async handleSaveEmergency(event) {
    event.preventDefault();
    this.isLoading = true;
    try {
      const contactRecord = {
        Id: this.selectedEmployee.id,
        Emergency_Contact_Name__c: this.emergencyForm.primaryName,
        Emergency_Contact_Relationship__c: this.emergencyForm.primaryRelationship,
        Emergency_Contact_Number__c: this.emergencyForm.primaryPhone1,
        Secondary_Emergency_Contact_Name__c: this.emergencyForm.secondaryName,
        Secondary_Emergency_Contact_Relationship__c: this.emergencyForm.secondaryRelationship,
        Secondary_Emergency_Contact_Number__c: this.emergencyForm.secondaryPhone1
      };
      ...
      this.showToast("Error", "Failed to update emergency contact: " + (err?.body?.message || err.message), "error");
    } finally {
      this.isLoading = false;
    }
  }
  ...
  async handleSavePersonal(event) {
    event.preventDefault();
    this.isLoading = true;
    try {
      const contactRecord = {
        Id: this.selectedEmployee.id,
        Passport_No__c: this.personalForm.passportNo,
        Nationality__c: this.personalForm.nationality,
        Religion__c: this.personalForm.religion,
        Marital_Status__c: this.personalForm.maritalStatus,
        Employment_of_Spouse__c: this.personalForm.spouseEmployment,
        No_of_Children__c: this.personalForm.noOfChildren ? Number(this.personalForm.noOfChildren) : null
      };
      await saveEmployee({ contactRecord });
      this.selectedEmployee = {
        ...this.selectedEmployee,
      ...
      this.showToast("Error", "Failed to update personal information: " + (err?.body?.message || err.message), "error");
    } finally {
      this.isLoading = false;
    }
  }
  ...
  async handleSaveBank(event) {
    event.preventDefault();
    this.isLoading = true;
    try {
      const contactRecord = {
        Id: this.selectedEmployee.id,
        Bank_Name__c: this.bankForm.bankName,
        Account_Number__c: this.bankForm.accountNo,
        SWIFT_Code__c: this.bankForm.ifscCode,
        Branch_Name_Code__c: this.bankForm.branch
      };
      await saveEmployee({ contactRecord });
      this.selectedEmployee = {
        ...this.selectedEmployee,
      ...
      this.showToast("Error", "Failed to update bank details: " + (err?.body?.message || err.message), "error");
    } finally {
      this.isLoading = false;
    }
  }
  ...
  async handleSaveFamily(event) {
    event.preventDefault();
    this.isLoading = true;
    try {
      const contactRecord = {
        Id: this.selectedEmployee.id,
        Family_Member_Name__c: this.familyForm.name,
        Family_Member_Relationship__c: this.familyForm.relationship,
        Family_Member_Phone__c: this.familyForm.phone
      };
      await saveEmployee({ contactRecord });
      this.selectedEmployee = {
        ...this.selectedEmployee,
      ...
      this.showToast("Error", "Failed to update family information: " + (err?.body?.message || err.message), "error");
    } finally {
      this.isLoading = false;
    }
  }
